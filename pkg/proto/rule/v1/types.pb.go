...
func (x *Condition) GetValue() float64 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *Overide) GetStartingAt() *timestamppb.Timestamp {
	if x != nil {
		return x.StartingAt
	}
	return nil
...
type Rule struct {
	...
	AutoAcknowledge        *wrapperspb.BoolValue  `protobuf:"bytes,2,opt,name=auto_acknowledge,json=autoAcknowledge,proto3" json:"auto_acknowledge,omitempty"`
	Enabled                *wrapperspb.BoolValue  `protobuf:"bytes,3,opt,name=enabled,proto3" json:"enabled,omitempty"`
	Triggered              *wrapperspb.BoolValue  `protobuf:"bytes,4,opt,name=triggered,proto3" json:"triggered,omitempty"`
	LastTriggered          *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=last_triggered,json=lastTriggered,proto3" json:"last_triggered,omitempty"`
	...
	TriggerOnConditionExit *wrapperspb.BoolValue  `protobuf:"bytes,19,opt,name=trigger_on_condition_exit,json=triggerOnConditionExit,proto3" json:"trigger_on_condition_exit,omitempty"`
	Delay                  int64                  `protobuf:"varint,20,opt,name=delay,proto3" json:"delay,omitempty"`
	StartingAt             *timestamppb.Timestamp `protobuf:"bytes,21,opt,name=starting_at,json=startingAt,proto3" json:"starting_at,omitempty"`
...
func (x *Rule) GetAutoAcknowledge() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *Rule) GetTriggered() *wrapperspb.BoolValue {
	if x != nil {
		return x.Triggered
	}
	return nil
...
func (x *Rule) GetLastTriggered() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Rule) GetTriggerOnConditionExit() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *Rule) GetStartingAt() *timestamppb.Timestamp {
	if x != nil {
		return x.StartingAt
	}
	return nil
